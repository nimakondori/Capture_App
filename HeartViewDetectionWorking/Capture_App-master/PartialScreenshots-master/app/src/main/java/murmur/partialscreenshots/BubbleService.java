                ...
                new ImageReader.OnImageAvailableListener() {
                    ...
                    public void onImageAvailable(ImageReader reader) {
                        try{
                            ...
                            if(image == null){
                                Log.d("Nima", "Image is Unavailabe => Freakout");
                            }
                            else
                            {
                ...
                new Runnable() {
                    ...
                    public void run()
                    {
                        if(QUSRunner != null)
                        {
                            ...
                            Bitmap bit = Bitmap.createBitmap(INPUT_WIDTH, INPUT_HEIGHT, Bitmap.Config.ARGB_8888); // creates a new bitmap to draw the scaled bitmapCut onto.
                            ...
                            //croptime = System.currentTimeMillis() - watch; watch = System.currentTimeMillis();
                            ...
                            //updateResultEvent();
                            //========================================================================================== Sets the results ===================================================================================================
//                                display_results.setTint1(1000);
//                                if(GLOBAL.count >= 50)
//                                {
//                                    display_results.setTint1(Integer.parseInt("FEFBDE"));
//                                }
                            }
                        }
                    });
