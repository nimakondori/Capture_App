...
import static murmur.partialscreenshots.BubbleService.AP4_IDX;
import static murmur.partialscreenshots.BubbleService.PLAX_IDX;
import static murmur.partialscreenshots.BubbleService.PSAXM_IDX;
import static murmur.partialscreenshots.BubbleService.SUBC4_IDX;
import static murmur.partialscreenshots.BubbleService.UNINIT_IDX;

//import static org.qus.viewqualTFLite.ViewQualActivity.OTHER_IDX;
...
public class TensorFlowQUSRunner implements Classifier {
    ...
    private static final int NUM_VIEWQUAL_RUNNERS = 5;
    ...
    public static Classifier create(
        ...
        //c.tfliteOptions.setNumThreads(4);
