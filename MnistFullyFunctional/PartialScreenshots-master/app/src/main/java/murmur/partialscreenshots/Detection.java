...
import static murmur.partialscreenshots.tflite.MnistModelConfig.CLASSIFICATION_THRESHOLD;
import static murmur.partialscreenshots.tflite.MnistModelConfig.MAX_CLASSIFICATION_RESULTS;

public class Detection {
    private final Interpreter interpreter;

    public Detection(Interpreter interpreter) {
        this.interpreter = interpreter;
    }

    public static Detection classifier(AssetManager assetManager, String modelPath) throws IOException {
        ...
        return new Detection(interpreter);
    }
