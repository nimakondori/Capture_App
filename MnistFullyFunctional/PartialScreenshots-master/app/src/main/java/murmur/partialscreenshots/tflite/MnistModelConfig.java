package murmur.partialscreenshots.tflite;
...
/**
 * Most of these information can be found in MNIST.ipynb
 */
/*
    This file is strictly for configuring the model-specific parameters such as 28px for MNIST_model.tflite input
 */
