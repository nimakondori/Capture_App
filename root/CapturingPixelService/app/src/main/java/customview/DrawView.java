...
import parisa.esh19.com.capturingpixelservice.R;
 ...
 *
 * Based on "http://chintanrathod.com/resizable-rectangle-overlay-on-touch-in-android/"
 *
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (eventaction) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                rad = colorballs.get(0).getWidthOfBall() / 2;

                x_lowest = colorballs.get(0).getX();
                x_highest = colorballs.get(0).getX();

                for (counter = 0; counter < 4; counter++) {

                    if (x_lowest > colorballs.get(counter).getX()) {
                        x_lowest = colorballs.get(counter).getX();
                    }
                    if (x_highest < colorballs.get(counter).getX()) {
                        x_highest = colorballs.get(counter).getX();
                    }
                }

                y_highest = colorballs.get(0).getY();
                y_lowest = colorballs.get(0).getY();

                for (counter = 0; counter < 4; counter++) {
                    if (y_lowest > colorballs.get(counter).getY()) {
                        y_lowest = colorballs.get(counter).getY();

                    }
                    if (y_highest < colorballs.get(counter).getY()) {
                        y_highest = colorballs.get(counter).getY();
                ...
                Width = x_highest - x_lowest;
                Height = y_highest - y_lowest;


                Log.i("low", "xlow = " + x_lowest);
                Log.i("low", "ylow = " + y_lowest);
